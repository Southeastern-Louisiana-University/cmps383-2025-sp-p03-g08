  ...
  return (
    <div className="homePage">
      ...
      <section className="homePage__foodAndDrinks">
        ...
        <div className="homePage__foodGrid">
          ...
          <div className="homePage__foodItem">
            ...
            <p>3 Delicious Cheeseburger Sliders dressed with cheddar cheese and a pickle</p>
          </div>
          <div className="homePage__foodItem">
      ...
      <section className="homePage__aboutUs">
        <h2>About Us</h2>
        <p>
          Welcome to Lion’s Den Cinemas, where we are dedicated to providing an exceptional experience.
          Whether you're here for the latest blockbuster or an independent film, we strive to create
          a comfortable and enjoyable atmosphere for all moviegoers.
        </p>
      </section>
